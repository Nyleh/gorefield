...
function create() 
{
    ...
    disclaimer.applyMarkup(
        ...
        "Este motor todavía está en estado alfa. Eso significa que *la mayoría de las funciones* tienen *defectos* o *no están terminadas*. Si encuentra algún error, por favor reportelo a Codename Engine GitHub.\n\nPresione ENTER para continuar" :
